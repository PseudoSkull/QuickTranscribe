...
def correct_text(text_file):
    ...
    x = x.replace("Ee", "Re")
    x = re.sub("([a-z]) The", "\1. The", x)
    x = re.sub("([a-z]) That", "\1. That", x)
    x = re.sub("([a-z]) This", "\1. This", x)
    x = re.sub("([a-z]) But ", "\1. But ", x)
    x = re.sub("([a-z]) So ", "\1. So ", x)
    x = re.sub("([a-z]) So,", "\1. So,", x)
    x = re.sub("([a-z]) Why", "\1. Why", x)
    x = re.sub("([a-z]) What", "\1. What", x)
    x = x.replace("/'", ".\"")
    x = x.replace("AU ", "All ")
    x = x.replace(" I\"", "!\"")
    x = x.replace(" I I", "! I")
